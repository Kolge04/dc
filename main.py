...
def button():
	BUTTON=[[InlineKeyboardButton(text="👨‍💻 Sahibim",url="t.me/muellime")]]
	BUTTON+=[[InlineKeyboardButton(text="📣 Kanal",url="t.me/ElxanBots")]]
